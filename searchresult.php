...
$find= $_GET['look'];
 ...
 $sql1 = "Select * from productinfo WHERE Product_Name LIKE '%".$find."%' AND ProductCategory='".$prodtype."' ";
 $sql2= "Select * from productinfo WHERE ProductCategory='".$prodtype."'AND Product_Name LIKE '%word%' OR Product_Name LIKE '%visual%' OR Product_Name LIKE '%windows%' OR Product_Name LIKE '%adobe%'";
